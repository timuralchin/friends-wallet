from server.apps.debts.models import ReceiptDebt, ReceiptPersonalDebt, TempDebts
...
class ReceiptServices:
    ...
    def create_debts(self):
        for subject in self.receipt.subjects.all():
            debt, _ = ReceiptDebt.objects.get_or_create(
                user=subject,
    ...
    def create_personal_debts(self):
        ...
        for debt in debts:
            ...
            for temp_credit in temp_credits:
                ...
                ReceiptPersonalDebt.objects.update_or_create(
                    amount=temp_amount,
                    receipt=self.receipt,
                    debtor=debt.user,
